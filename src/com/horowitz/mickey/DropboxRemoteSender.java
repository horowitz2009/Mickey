...
public class DropboxRemoteSender {
  public static void main(String[] args) {
    JFrame frame = new JFrame("DropboxRemoteSender 926");
    ...
    DropboxRemoteSender dr = new DropboxRemoteSender();
    dr.runListener();
  }
