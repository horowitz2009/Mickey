...
public final class MainFrame extends JFrame {
  ...
  private static final String APP_TITLE    = "Mickey v0.626beta";
  ...
  private boolean _fastClickReady = false;
  private boolean _tmDetected     = false;
  ...
  private boolean clickHomeOneClick() throws AWTException, IOException, RobotInterruptedException, SessionTimeOutException, DragFailureException {
    ...
    do {
      ...
      final Pixel p = detectPointerDown();
      if (p != null) {
