...
public class Locations {
  ...
  public static int[]      RAILS4_WOLF     = { RAIL1 - 6, RAIL1 - 2, RAIL1 + 3, RAIL1 + 8 };                        // wolfgang
	 ...
	 * @deprecated
	 */
  public static int[]      RAILS4_SMIX     = { RAIL1 - 2, RAIL1, RAIL1 + 3, RAIL1 + 8, RAIL1 + 11, RAIL1 + 16,
      RAIL1 + 21, RAIL1 + 26, RAIL1 + 31  };                                                                       // small
                                                                                                                     // mix
  ...
  public static int[]      RAILS4_WOLF_BIG = { RAIL1 + 27, RAIL1 + 37, RAIL1 + 46, RAIL1 + 56 };                    // wolfgang
	 ...
	 * @deprecated
	 */
  public static int[]      RAILS4_BMIX     = { RAIL1, RAIL1 + 7, RAIL1 + 13, RAIL1 + 20, RAIL1 + 27, RAIL1 + 37,
      RAIL1 + 46, RAIL1 + 56              };
  ...
  public static Location   LOC_3HOURS      = new Location(" 3h ", 180, new Point(341, 267 + 169), 1);
	public static Location[]	LOC_PAGE1	     = new Location[] { LOC_0MIN, LOC_6MIN, LOC_10MIN, LOC_30MIN, LOC_1HOUR, LOC_2HOURS,
      LOC_3HOURS,                         };
  ...
  public static Location[] LOC_PAGE2       = new Location[] { LOC_4HOURS, LOC_6HOURS, LOC_8HOURS, LOC_10HOURS,
      LOC_12HOURS, LOC_18HOURS,           };
  ...
  public static Location[] LOC_PAGE3       = new Location[] { LOC_1DAY, LOC_2DAYS, LOC_1WEEK };
  ...
  public static Dimension  GAME_SIZE       = new Dimension(775, 585);
	 ...
	 * @deprecated
	 */
  public static Rectangle  LEFTARROW_ZONE  = new Rectangle(0, -RAIL1 - ARROW_LR_SIZE.height * 3,
                                               ARROW_LR_SIZE.width + 45, ARROW_LR_SIZE.height * 3);
